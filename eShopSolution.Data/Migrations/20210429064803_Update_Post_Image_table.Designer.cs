...
namespace eShopSolution.Data.Migrations
{
    ...
    [Migration("20210429064803_Update_Post_Image_table")]
    partial class Update_Post_Image_table
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("eShopSolution.Data.Entities.AppRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "8b24d38e-82ec-4c40-94aa-0db7a233bb14",
            ...
            modelBuilder.Entity("eShopSolution.Data.Entities.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "25e909fe-ac88-4146-b7d8-4e77ed44d22b",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEJJn15APHsvkvSx7+fGXdRsRo2Mku41PZ5Jdyy/SjAbeYlbkefWWaLyZB6bp2reoMA==",
            ...
            modelBuilder.Entity("eShopSolution.Data.Entities.Post", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2021, 4, 29, 13, 48, 2, 694, DateTimeKind.Local).AddTicks(7108)
                        });
                });

            modelBuilder.Entity("eShopSolution.Data.Entities.PostImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("eShopSolution.Data.Entities.PostTranslation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("eShopSolution.Data.Entities.Product", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2021, 4, 29, 13, 48, 2, 693, DateTimeKind.Local).AddTicks(9988),
            ...
            modelBuilder.Entity("eShopSolution.Data.Entities.ProductColor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("eShopSolution.Data.Entities.PostImage", b =>
                {
                    b.HasOne("eShopSolution.Data.Entities.Post", null)
                        .WithMany("PostImages")
